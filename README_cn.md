...
1. 下载`manifest.xml`文件并保存到你的电脑上，例如 `C:\Users\username\Documents\WordGPT`.
  - 非中国地区: [release/other/manifest.xml](https://release.piclist.cn/release/other/manifest.xml)
  - 中国地区: [release/china/manifest.xml](https://release.piclist.cn/release/china/manifest.xml)
