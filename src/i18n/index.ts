...
const messages = {
  en: {
    ...
    officialBasePathLabel: 'Base URL',
    officialBasePathPlaceholder: 'Base URL',
  ...
  'zh-cn': {
    ...
    useWordFormattingLabel: 'Word格式化',
    apiLabel: 'API',
    ...
    agentModeLabel: 'Agent模式',
    agentModePlaceholder: '请选择Agent模式',
    agentMaxStepsLabel: '最大步骤数',
    agentMaxStepsPlaceholder: 'Agent工作流的最大步骤数',
    agentThinkingDepthLabel: '思考深度',
    agentThinkingDepthPlaceholder: 'Agent思考复杂度等级',
    agentAutoExecuteLabel: '自动执行',
    agentAutoExecutePlaceholder: '自动执行步骤',
    agentBaseModeAPILabel: '基础API',
    agentBaseModeAPIPlaceholder: '选择Agent模式的基础API',
    agent: 'Agent',
    translate: '翻译',
    summary: '摘要',
    polish: '润色',
